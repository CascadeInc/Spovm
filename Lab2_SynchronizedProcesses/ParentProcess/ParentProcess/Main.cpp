...
int main(int argc, char *argv[])
{
	...
	while (1) {
		...
		{
			Sleep(400);
			CreateProcess(L"D:\\LABS_BSUIR\\SPOVM\\Lab2_SynchronizedProcesses\\ChildProcess\\Debug\\ChildProcess.exe", NULL, FALSE, NULL, NULL, CREATE_NEW_CONSOLE, NULL, NULL, &si, &pi);
